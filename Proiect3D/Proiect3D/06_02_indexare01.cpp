...
void CreateVBO(void)
{
	...
	{
	-25.0f, -5.0f, 0.0f, 1.0f,//J
	-15.0f, -5.0f, 0.0f, 1.0f,//F
	-15.0f, 5.0f, 0.0f, 1.0f,//E
	-25.0f, 5.0f, 0.0f, 1.0f,//I

	-15.0f, -5.0f, 0.0f, 1.0f,//F
	-5.0f, -5.0f, 0.0f, 1.0f,//A
	-5.0f, 5.0f, 0.0f, 1.0f,//D
	-15.0f, 5.0f, 0.0f, 1.0f,//E

	-5.0f, -5.0f, 0.0f, 1.0f,//A
	5.0f, -5.0f, 0.0f, 1.0f,//B
	5.0f, 5.0f, 0.0f, 1.0f,//C
	-5.0f, 5.0f, 0.0f, 1.0f,//D

	5.0f, -5.0f, 0.0f, 1.0f,//B
	15.0f, -5.0f, 0.0f, 1.0f,//H
	15.0f, 5.0f, 0.0f, 1.0f,//G
	5.0f, 5.0f, 0.0f, 1.0f,//C

	15.0f, -5.0f, 0.0f, 1.0f,//H
	25.0f, -5.0f, 0.0f, 1.0f,//L
	25.0f, 5.0f, 0.0f, 1.0f,//K
	15.0f, 5.0f, 0.0f, 1.0f,//G
	};
	// culorile varfurilor

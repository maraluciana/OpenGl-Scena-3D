...
glm::mat4 
	matrScale,matrTransl,myMatrix, resizeMatrix = glm::ortho(-width, width, -height, height);
...
void RenderFunction(void)
{
	...
	matrTransl = glm::translate(glm::mat4(1.0f), glm::vec3(30.0, 30.0, 0.0));

	//myMatrix = resizeMatrix * matrScale * matrTransl; // a
	//glLineWidth(4);

...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		// coordonate                   // culori			
		-50.0f,  -50.0f, -50.0f, 1.0f,  0.0f, 1.0f, 0.0f, //A
		50.0f,  -50.0f,  -50.0f, 1.0f,   0.0f, 0.9f, 0.0f, //B
		50.0f,  50.0f,  -50.0f, 1.0f,    0.0f, 0.6f, 0.0f, //C
		-50.0f,  50.0f, -50.0f, 1.0f,   0.0f, 0.2f, 0.0f, //D
		// varfurile (~rosii) din planul z=+50  
		// coordonate                   // culori			
		0.0f,  0.0f, 50.0f, 1.0f,  1.0f, 0.0f, 0.0f, //E
	};
...
int main(int argc, char* argv[])
{
	...
	glutCreateWindow("Desenare piramida");
	glewInit();
	Initialize();

...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		// coordonate                   // culori			
		-50.0f,  -50.0f, -50.0f, 1.0f, //A
		50.0f,  -50.0f,  -50.0f, 1.0f, //B
		50.0f,  50.0f,  -50.0f, 1.0f,  //C
		-50.0f,  50.0f, -50.0f, 1.0f,  //D
		// varfurile (~rosii) din planul z=+50  
		// coordonate                   // culori			
		0.0f,  0.0f, 50.0f, 1.0f,   //E
	};
	...
	for (int n = 0; n < INSTANCE_COUNT; n++)
	{
		MatModel[n] = 
			glm::translate(glm::mat4(1.0f), 
				glm::vec3(
					400 * cos(2.f * (n / 2) * PI / INSTANCE_COUNT), //y
					400 * sin(2.f * (n / 2) * PI / INSTANCE_COUNT), //x
					0.0)) 

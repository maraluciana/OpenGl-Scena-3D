...
GLuint
	...
	l1, l2,
	codCol;
GLint objectColorLoc, lightColorLoc, lightPosLoc, viewPosLoc, ambientColorLoc;
...
void RenderFunction(void)
{
	...
	glUniform3f(lightColorLoc, 1.0f, 221 / 225.0f, 124 / 255.0f);
	glUniform3f(ambientColorLoc, 0.0f, 201 / 225.0f, 1.0f);
	glUniform3f(lightPosLoc, 0.0f, -400.f, 400.f);
